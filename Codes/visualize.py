...
from models import TruckResnet18, TruckResnet34, TruckResnet50, TruckResnet101, TruckResnet152, GoogLeNet, GoogLeNetPlus, ResNet, BasicBlock, attention56
...
def train(cont=False):
    ...
    if net == "TruckResnet18":
        ...
        model = ResNet(BasicBlock, [3,4,4,3]) # ResNet30-> 3,4,4,3; ResNet26-> 3,3,3,3; ResNet22-> 2,3,3,2
    elif net == "GoogLeNet":
        model = GoogLeNet()
